...
const podcastsData = [
  ...
  },
  {
    ...
    description: "Environmental journalist Alex Marino interviews eco-designer Emma Thompson on practical ways to create a more sustainable home without sacrificing style.",
    image: "/business1.jpg",
    category: "LIFESTYLE",
    host: "Alex Marino",
    guest: "Emma Thompson",
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-2/3 lg:pr-8">
          ...
          <div className="lg:space-y-12 md:space-y-8 space-y-6">
            {filteredPodcasts.map(podcast => (
              <div key={podcast.id} className="flex flex-col md:flex-row border-b pb-8">
                ...
                <div className="w-full md:w-2/3 md:pl-6">
                  <div className="text-red-500 text-sm font-medium mb-2">{podcast.category}</div>
                  ...
                  <div className="flex items-center text-sm text-gray-600 mb-4">
                    <div className="mr-4">Host: <span className="font-medium">{podcast.host}</span></div>
                    <div>Guest: <span className="font-medium">{podcast.guest}</span></div>
                  </div>
                  <div className="flex items-center text-sm text-gray-600">
                    <div className="mr-4">{podcast.date}</div>
                    <div className="mr-4">{podcast.duration}</div>
        ...
        <div className="w-full lg:w-1/3 mt-12 lg:mt-0">
                ...
                <div key={podcast.id} className="flex">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      in <span className="text-gray-900">{podcast.category}</span>
                      <span className="mx-2">•</span>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm mt-8">
            ...
            <p className="text-gray-700 mb-4">Get the latest podcasts and updates delivered to your inbox.</p>
            <input 
              type="email" 
