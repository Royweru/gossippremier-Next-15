  ...
  return (
    ...
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-4 md:gap-6 px-4">
      ...
      <header className="pb-8 mb-2 border-b">
        ...
        <article className="mb-4 bg-white rounded-lg overflow-hidden shadow-md flex flex-col md:flex-row">
          ...
          <div className="p-6 md:w-3/5">
            ...
            <p className="text-gray-600 mb-4 line-clamp-3">
              As more consumers wake up to the damaging impact of fast fashion on the planet and its people, committing to only shopping second hand seems like an easy win...
            </p>
        ...
        {/* Second Article */}
        <article className="mb-4 bg-white rounded-lg overflow-hidden shadow-md flex flex-col md:flex-row">
          <div className="md:w-2/5 bg-blue-100 relative">
            <img 
              src="/podcast3.jpg" 
          ...
          <div className="p-6 md:w-3/5">
            <span className="inline-block px-3 py-1 bg-pink-500 text-white text-xs font-semibold rounded-md mb-3">
              BEAUTY
            </span>
            <h2 className="text-2xl font-bold text-gray-800 mb-3">
              I Tried That Viral Face Serum and Here&apos;s My Honest Review
            </h2>
            <p className="text-gray-600 mb-4 line-clamp-3">
              I&apos;ve always heard about vitamin-packed face serums for giving skin a healthy, next-level glow but this one claims to transform your skin overnight. After two weeks of testing...
            </p>
            <div className="flex items-center text-gray-500 text-sm">
              <span className="mr-3">By BEAUTYINSIDER</span>
              <span className="flex items-center mr-3">
                <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"></path>
                </svg>
