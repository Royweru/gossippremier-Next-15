  ...
  const faqData = [
    {
      ...
      answer: 'You can subscribe to our newsletter by entering your email address in the subscription box at the bottom of our homepage or on this contact page.'
    },
    {
      question: 'How can I contribute to Glossier?',
      answer: 'We welcome guest contributions from fashion and beauty experts. Please email us at contributors@glossier.com with your portfolio and pitch.'
    },
    {
      question: 'Do you accept advertising partnerships?',
      answer: 'Yes, we work with select brands that align with our values. Please contact our advertising team at advertising@glossier.com for more information.'
    },
    {
      question: 'How quickly can I expect a response?',
      answer: 'We aim to respond to all inquiries within 1-2 business days. For urgent matters, please call our office directly.'
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50 md:py-8 py-6">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="bg-gray-900 rounded-lg p-8 text-center">
          ...
          <p className="text-gray-300 mb-6 max-w-lg mx-auto">Stay updated with our latest articles, podcasts, and fashion trends delivered straight to your inbox.</p>
      ...
      <div className="bg-white py-12">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="flex justify-center space-x-6 mb-8">
            <a href="#" className="w-12 h-12 flex items-center justify-center rounded-full bg-gray-100 text-gray-700 hover:bg-red-500 hover:text-white transition duration-200">
